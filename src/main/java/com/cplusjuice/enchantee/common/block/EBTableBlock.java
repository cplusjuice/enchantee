...
public class EBTableBlock extends EnchanteeBlock implements ITileEntityProvider {

    public static final String NAME = "enchantment_breaking_table";
    ...
    public boolean onBlockActivated(World world,
        ...
        if (!world.isRemote) {
            entityPlayer.openGui(EnchanteeMod.INSTANCE, GuiHandler.ENCHANTMENT_BREAKING_TABLE_ID,
